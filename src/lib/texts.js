...
export const textContent = [
  {
    title: "About me",
    description: <Fragment>I’m a full stack software engineer living in Berlin since 2013. Three years ago, with 7 years of experience as a marketing specialist, I decided to switch careers and become a Software Engineer. <br/>What an <a href="https://www.youtube.com/watch?v=UMqg37sPwAA" target="_blank" rel="noreferrer">exciting and challenging journey! </a><br/>On 2018, I got a job opportunity at <a href="https://unumotors.com" target="_blank" rel="noreferrer">unumotors</a>, and since then I’ve been learning from that amazing team and enjoying creating useful applications, developing features and solving problems. <br/>Right now I'm open to new opportunities!
